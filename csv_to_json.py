...
with open('/mnt/user-data/uploads/dispositifs_csti.csv', 'r', encoding='utf-8') as f:
    dispositifs = list(csv.DictReader(f))
...
with open('/mnt/user-data/outputs/content.json', 'w', encoding='utf-8') as f:
    json.dump(h5p, f, indent=2, ensure_ascii=False)

print(f"✓ {len(content)} contenus créés")